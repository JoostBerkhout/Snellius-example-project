...
EST_SEC_PER_TASK = 5.0  # estimated seconds per task
PARTITION_NAME = "rome"
MAX_CORES_PER_NODE = 128  # in PARTITION_NAME
...
# version automatically anymore [I guess due to the copying to scratch])
